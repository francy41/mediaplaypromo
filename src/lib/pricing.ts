...
// ═══════════════════════════════════════════════════════════════
// 🎬 PLANES VIDEO — Optimizados para generación de videos
// (Próximamente: PLANES IMAGEN separados)
// ═══════════════════════════════════════════════════════════════
...
export const PLANS: PricingPlan[] = [
  {
    id: "free",
    name: "Free Video",
    tagline: "Prueba con videos básicos",
    priceMonthly: 0,
    priceYearly: 0,
    credits: 10,
    models: "basic",
    ...
    features: [
      "10 videos / mes con Wan 2.2 Fast",
      "Resolución 480p · 5 seg max",
      "Marca de agua MediaPlayPromo",
      "Comunidad Discord",
    ],
    notIncluded: ["Veo 3 / Kling / Sora", "Modelos premium", "Resolución 1080p"],
    cta: "Empezar gratis",
  },
  {
    id: "starter",
    name: "Starter Video",
    tagline: "Para creadores casuales",
    priceMonthly: 19,
    priceYearly: 190,
    credits: 100,
    models: "basic",
    ...
    features: [
      "100 videos / mes Budget tier",
      "Wan, Seedance, Hailuo Fast, Hunyuan",
      "Resolución 720p HD",
      "Sin marca de agua",
      "Hasta 10 seg por video",
      "Soporte email <48h",
    ],
    notIncluded: ["Veo 3 / Kling Pro / Sora", "1080p Full HD", "Marca blanca"],
    cta: "Empezar Starter",
    stripePriceMonthly: "price_starter_monthly_mock",
    stripePriceYearly: "price_starter_yearly_mock",
  },
  {
    id: "pro",
    name: "Pro Video",
    ...
    popular: true,
    features: [
      "≈ 50 videos Veo 3 Fast / mes",
      "≈ 30 videos Kling Turbo Pro / mes",
      "Veo 3, Kling, Grok, Hailuo, Wan, Seedance",
      "Resolución 1080p Full HD",
      "Hasta 30 seg por video",
      "Sin marca de agua · uso comercial",
  ...
  },
  {
    ...
    features: [
      "≈ 250 videos Veo 3 Fast / mes",
      "≈ 80 videos Veo 3.1 / mes",
      "≈ 70 videos Sora 2 Pro / mes",
      "TODOS los modelos incluyendo Sora 2 Pro y Veo 3.1",
      "Cola prioritaria · sin esperas",
  ...
  },
  {
    ...
    features: [
      "Videos ilimitados",
      "Sora 2 Pro + Veo 3.1 Ultra incluidos",
