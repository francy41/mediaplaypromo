...
export const ADMIN_MODULES: AdminModule[] = [
  ...
  { id: "marketplace", title: "Marketplace", description: "Productos, servicios y aprobaciones", href: "/admin/marketplace",
    icon: ShoppingBag, group: "Comercio", iconBg: "bg-rose-500/15", iconText: "text-rose-400",
    status: "beta", kpi: { label: "Listings", value: 0 } },
