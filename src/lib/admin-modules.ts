...
export const ADMIN_MODULES: AdminModule[] = [
  ...
  { id: "studio", title: "Estudio de Guión IA", description: "Elige duración, modelo y voz → guión consistente + clips IA en galería. Regenera, descarga o añade al editor", href: "/studio",
    icon: Sparkles, group: "Contenido", iconBg: "bg-violet-500/15", iconText: "text-violet-300",
    status: "beta", kpi: { label: "Guión", value: "IA" } },
  { id: "thumbnails", title: "Miniaturas de YouTube", description: "Escribe el tema → IA genera el titular, busca el fondo y monta la miniatura. Edita y descarga en 1280×720", href: "/thumbnails",
    icon: ImageIcon, group: "Contenido", iconBg: "bg-rose-500/15", iconText: "text-rose-400",
    status: "beta", kpi: { label: "Formato", value: "16:9" } },
  ...
  { id: "planner-admins", title: "Admins del Planificador", description: "Crea administradores con acceso gratis al Planificador y sus propias cuentas GHL", href: "/admin/planner-admins",
    icon: UserCheck, group: "Usuarios", iconBg: "bg-pink-500/15", iconText: "text-pink-400",
    status: "live", kpi: { label: "Acceso", value: "Código" } },
