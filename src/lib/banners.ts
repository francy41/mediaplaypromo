...
export const DEFAULT_BANNERS: Banner[] = [
  {
    ...
    enabled: true,
    order: 1,
    badge: "SUITE PROFESIONAL PARA CREADORES",
    title: "CREA. EDITA.",
    accent: "AUTOMATIZA.",
    subtitle:
    ...
    ctaHref: "/register",
    secondaryLabel: "EXPLORAR YF AUTO CLIP",
  ...
  },
  {
    ...
    title: "GANA EL 30%",
    accent: "DE POR VIDA.",
    subtitle: "Comisiones recurrentes automáticas con Stripe y PayPal. Únete a la red.",
    ctaLabel: "UNIRME AHORA",
    ctaHref: "/affiliate",
    secondaryLabel: "VER CONDICIONES",
  ...
  },
  {
    ...
    title: "TU PROPIA",
    accent: "PLATAFORMA.",
    subtitle: "Dominio propio, branding completo y clientes bajo tu marca personal.",
